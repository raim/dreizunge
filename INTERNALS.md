...
**The jobs popover (item U, `roadmap_v87.md`, `v87_b`/`v87_c`)** — "a single place to see everything
in flight"; the running/scheduled-jobs half only, "unfinished projects" still blocked on item R.
