# Session prompt — written at the `v91_c` cut
...
zero-dependency Node language-learning app). Picking up from **`v91_c`**. `roadmap_v91.md` was cut at
...
snapshot; re-measure fresh at commit time. `APP_VERSION = 'v91_c'`.
