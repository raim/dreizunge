# Session prompt — written at the `v89` cut
...
zero-dependency Node language-learning app). Picking up from **`v89`**. `roadmap_v89.md` was cut at
...
**NOTHING IS OWED.** Every item the `v88` line was handed shipped. **Ask the user what they want
...
snapshot; re-measure fresh at commit time. `APP_VERSION = 'v89'`.
