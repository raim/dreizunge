# Session prompt — written at the `v90_s` cut
...
zero-dependency Node language-learning app). Picking up from **`v90_s`**. `roadmap_v90.md` was cut at
...
Corpus at this cut: **361 topics, 100 storylines, 33 languages, 745 `en` keys** — an inherently live
snapshot; re-measure fresh at commit time. `APP_VERSION = 'v90_s'`.
