# Session prompt — written at the `v90_r` cut
...
zero-dependency Node language-learning app). Picking up from **`v90_r`**. `roadmap_v90.md` was cut at
...
```
node test/run.js                          → expect 373 checks
node test/run.js --quick                  → expect 307
