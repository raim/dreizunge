...
**To see it:** open any storyline you have not started. The bar must be EMPTY. Before `v81_g` every
deck showed some green immediately, and all 27 single-chapter decks showed a FULL bar and `1/1`.
