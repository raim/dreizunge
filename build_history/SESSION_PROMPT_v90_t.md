# Session prompt — written at the `v90_t` cut
...
zero-dependency Node language-learning app). Picking up from **`v90_t`**. `roadmap_v90.md` was cut at
...
snapshot; re-measure fresh at commit time. `APP_VERSION = 'v90_t'`.
